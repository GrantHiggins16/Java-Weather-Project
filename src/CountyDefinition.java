...
public class CountyDefinition extends MultiStatisticsAbstract 
{
    ...
    public CountyDefinition(String[] elements)
    {
        ...
        {
            int longitude = 
                    (int) (Integer.parseInt(elements[i]) * 
                    StateFrame.LONGITUDE_SCALE);
            int latitude =
                    (int) (Integer.parseInt(elements[i + 1]) *
    ...
    {
        // TODO: Fill with painted color
        g2.setColor(getColor());
        g2.fillPolygon(polygon);
        // TODO: Outline is black
        g2.setColor(Color.BLACK);
        g2.draw(polygon);

        // TODO: draw stations
        for (StationDefinition sd : stations.values())
        {
            sd.draw(g2);
        }
    }
