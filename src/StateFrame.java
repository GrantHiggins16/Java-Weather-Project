    ...
    public class CountyPanel extends JPanel
    {
        ...
        public CountyPanel()
        {
            ...
            this.addMouseListener(new MouseAdapter()
            {
                ...
                public void mouseClicked(MouseEvent e)
                {
                    ...
                    // TODO: What county has been clicked?
                    CountyDefinition cd = 
                            StateFrame.this
                            .countyDefinitionList.findCounty(x, y);
                    // TODO: Open a CountyFrame for the selected county 
                    // if there is one.
                    CountyFrame cf = new CountyFrame(cd);
                    
                }

            });
            // Create color bar
            // TODO: create the color bar
            
            colorBar = new ColorBar(XVARIABLE, YVARIABLE + offsetY, 80, 100, 20, 1, 1, 1, 1, 1, 1); 
        ...
        protected void paintComponent(Graphics g)
        {
            ...
            if (dataDefinition != null)
            {
                ...
                // TODO: get the units for the variable
                g2.drawString(dataDefinition.getUnit(), XVARIABLE, 
                        YVARIABLE + (offsetY * 2));
                // TODO: draw the units string
            }
        ...
        public synchronized void updateData()
        {
            ...
            // TODO: add the appropriate years to constraintsYear
            else
            {
            ...
            // TODO: add the appropriate months to constraintsMonth
            else
            {
            ...
            // TODO: add the appropriate days to constraintsDay
            else
            {
            ...
            // TODO: set statType to one of MAXIMUM, AVERAGE, MINIMUM, depending
            // on what was selected by the user
            
            //for compiler
            StatType statType = null;
            if (StateFrame.this.selectionPanel
                    .maxButton.isSelected())
            {
                statType = StatType.MAXIMUM;
            }
            
            else if (StateFrame.this.selectionPanel
